                    ...
                    <Table>
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell>起訖站</StyledTableCell>
                                <StyledTableCell>出發站</StyledTableCell>
                                <StyledTableCell>抵達站</StyledTableCell>
                                <StyledTableCell>進站時間</StyledTableCell>
                                <StyledTableCell>抵達時間</StyledTableCell>
                            ...
                            {this.props.data.map((row, index) => {
                                ...
                                if(index >= displayStart && index < displayEnd) {
                                    return (<TableRow key={row.TrainNo}>
                                        ...
                                        <TableCell>{`${row.StartingStationName}->${row.EndingStationName}`}</TableCell>
                                        <TableCell>{row.DepartureStationName}</TableCell>
                                        <TableCell>{row.ArrivalStationName}</TableCell>
